...
type alias Model = { currSet : Set.Tree ModelData
...
initialModel : Model
initialModel = { currSet = Set.empty
...
toClass : Set.Tree ModelData -> ClassNames -> Set.Tree ModelData
toClass tree cl = Set.map (\ md -> {md | classes = cl}) tree

clearClasses : Set.Tree ModelData -> Set.Tree ModelData
clearClasses tree = toClass tree ""

updateSet : Model -> Set.Tree ModelData -> Maybe String -> (Model, Cmd Msg)
updateSet model tree notice =
    let
